    ...
    public static List<ArrangementItemDto> getArrangementsByLegalEntityId(String externalLegalEntityId,
        ...
        switch (externalLegalEntityId.trim()) {
            ...
            case "CompanyABC":
                ...
                break;
            case "MyNewUserLE":
                arrangementItems.add(mapper.map(getCurrentAccount(debitCards, additions), "LINKING_ARRANGEMENT_MyNewUserLE_01", "productId1"));
                arrangementItems.add(mapper.map(getSavingsAccount(debitCards, additions), "LINKING_ARRANGEMENT_MyNewUserLE_02", "productId2"));
                break;

            case "lisaID":
                arrangementItems.add(mapper.map(getCurrentAccount(debitCards, additions), "LINKING_ARRANGEMENT_lisaID_01", "productId1"));
                arrangementItems.add(mapper.map(getSavingsAccount(debitCards, additions), "LINKING_ARRANGEMENT_lisaID_02", "productId2"));
                break;
            case "mathewID":
                arrangementItems.add(mapper.map(getCurrentAccount(debitCards, additions), "LINKING_ARRANGEMENT_mathewID_01", "productId1"));
                arrangementItems.add(mapper.map(getSavingsAccount(debitCards, additions), "LINKING_ARRANGEMENT_mathewID_02", "productId2"));
                break;
            case "ericID":
                arrangementItems.add(mapper.map(getCurrentAccount(debitCards, additions), "LINKING_ARRANGEMENT_ericID_01", "productId1"));
                arrangementItems.add(mapper.map(getSavingsAccount(debitCards, additions), "LINKING_ARRANGEMENT_ericID_02", "productId2"));
                break;
            ...
            case "Real Estate":
                ...
                break;
            case "CORPCUST_1":
                arrangementItems.add(mapper.map(getCurrentAccount(debitCards, additions), "LINKING_ARRANGEMENT_03", "productId1"));
            ...
            case "RealEstateCommercial1":
                arrangementItems.add(mapper.map(getCurrentAccount(debitCards, additions), "LINKING_ARRANGEMENT_RealEstateCommercial1_03", "productId1"));
                ...
                break;
            case "Company1":
                arrangementItems.add(mapper.map(getCurrentAccount(debitCards, additions), "LINKING_ARRANGEMENT_Company1_03", "productId1"));
                ...
                break;
            case "CORPCUST_2":
                arrangementItems.add(mapper.map(getCurrentAccount(debitCards, additions), "LINKING_ARRANGEMENT_02", "productId1"));
                arrangementItems.add(mapper.map(getSavingsAccount(debitCards, additions), "LINKING_ARRANGEMENT_04", "productId2"));
            ...
            case "RealEstateCommercial2":
                arrangementItems.add(mapper.map(getCurrentAccount(debitCards, additions), "LINKING_ARRANGEMENT_RealEstateCommercial2_02", "productId1"));
                ...
                break;
            case "Company2":
                arrangementItems.add(mapper.map(getCurrentAccount(debitCards, additions), "LINKING_ARRANGEMENT_Company2_02", "productId1"));
            ...
            case "RealEstateCommercial3":
                arrangementItems.add(mapper.map(getCurrentAccount(debitCards, additions), "LINKING_ARRANGEMENT_RealEstateCommercial3_02", "productId1"));
                ...
                break;
            case "Company3":
                arrangementItems.add(mapper.map(getCurrentAccount(debitCards, additions), "LINKING_ARRANGEMENT_Company3_902", "productId1"));
                ...
                break;
            case "Summit Company":
                arrangementItems.add(mapper.map(getCurrentAccount(debitCards, additions), "LINKING_ARRANGEMENT_Summit Company_902", "productId1"));
                arrangementItems.add(mapper.map(getSavingsAccount(debitCards, additions), "LINKING_ARRANGEMENT_Summit Company_904", "productId2"));
                //arrangementItems.add(mapper.map(getInvestmentAccount(debitCards, additions), "LINKING_ARRANGEMENT_Company3_906", ""));
                break;
            default:
