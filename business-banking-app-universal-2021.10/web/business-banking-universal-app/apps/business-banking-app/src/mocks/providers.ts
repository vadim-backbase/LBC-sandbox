...
import {
  ...
  ApprovalsHttpServiceMocksProvider as ContactsApprovalsHttpServiceMocksProvider,
} from '@backbase/data-ang/contact-manager';
import {
  BatchUploadsHttpServiceMocksProvider,
  BatchOrdersHttpServiceMocksProvider,
...
import {
  PaymentOptionsHttpServiceMocksProvider,
  SanctionedCurrenciesHttpServiceMocksProvider,
  SanctionedCountriesHttpServiceMocksProvider,
...
import { SweepRulesHttpServiceMocksProvider } from '@backbase/data-ang/cash-management';
import {
  ApprovalsHttpServiceMocksProvider as AccessControlApprovalsHttpServiceMocksProvider,
...
import {
  ...
  UserApprovalsServiceMocksProvider,
  UserProfileManagementServiceMocksProvider,
} from '@backbase/data-ang/user';
import { CashManagementCustomSweepMockProvider } from '@backbase/cash-management-common';
import {
...
import { TradingFxMocksProvider } from '@backbase/business-ang/trading-fx';
import { TradingHttpServiceMocksProvider } from '@backbase/data-ang/trading-fx';
import { StopChecksHttpServiceMocksProvider } from '@backbase/data-ang/stop-checks';
import { BalanceHistoryInterceptorProvider } from './balance-history/balance-history.interceptor';
...
import { NotificationsMocksProvider } from '@backbase/business-ang/notifications';
import { ActionsMocksProvider } from '@backbase/business-ang/actions';
import { NotificationsHttpServiceMocksProvider } from '@backbase/data-ang/notifications';
import { ApprovalsMocksProvider } from '@backbase/entitlements-ang/approval';
import { LimitsHttpServiceMocksProvider } from '@backbase/data-ang/limits';
import { ManageMyDevicesServiceMocksProvider } from '@backbase/data-ang/device-management';
import {
  SmeHttpServiceMocksProvider,
  AccountingPlatformsHttpServiceMocksProvider,
  PayablesHttpServiceMocksProvider,
  ReceivablesHttpServiceMocksProvider,
  ForecastsHttpServiceMocksProvider,
  DefaultCurrencyHttpServiceMocksProvider,
  ChartOfAccountsHttpServiceMocksProvider,
  ForecastConfigurationsHttpServiceMocksProvider,
} from '@backbase/data-ang/cash-flow';

import { PositivePayChecksHttpServiceMocksProvider } from '@backbase/data-ang/positive-pay-check-v1';
import { PositivePayAchRulesHttpServiceMocksProvider } from '@backbase/data-ang/positive-pay-ach-v1';
...
// Mock provider for PortalContentService,
// which is responsble of getting the content from content services.
export const PortalContentServiceMockProvider = {
  ...
  getContent: (contentRef: string) => {
    const contentRefs: { [key: string]: any } = {
      '{"kind":"content","path":"backgrounds-login-collection.json"}': {
        backgrounds: [
          {
            image: { url: '/../../content/backgrounds-login-2x.jpg' },
            size: 'cover',
            positionX: 'center',
            positionY: 'center',
            repeat: 'no-repeat',
...
export const mockProviders: Array<Provider> = [
  ...
  ApprovalsMocksProvider,
  AccessControlApprovalsHttpServiceMocksProvider,
  ServiceAgreementsHttpServiceMocksProvider,
  LegalEntitiesHttpServiceMocksProvider,
  FunctionGroupsHttpServiceMocksProvider,
  ...
  UserContextHttpServiceMocksProvider,
  UserManagementServiceMocksProvider,
  PositivePayChecksHttpServiceMocksProvider,
  PositivePayAchRulesHttpServiceMocksProvider,
