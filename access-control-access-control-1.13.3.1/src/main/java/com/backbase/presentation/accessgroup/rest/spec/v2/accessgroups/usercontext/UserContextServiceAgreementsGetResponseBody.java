...
package com.backbase.presentation.accessgroup.rest.spec.v2.accessgroups.usercontext;
...
public class UserContextServiceAgreementsGetResponseBody implements AdditionalPropertiesAware
{
    ...
    public UserContextServiceAgreementsGetResponseBody withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public UserContextServiceAgreementsGetResponseBody withExternalId(String externalId) {
        this.externalId = externalId;
        return this;
    }
    ...
    public UserContextServiceAgreementsGetResponseBody withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public UserContextServiceAgreementsGetResponseBody withDescription(String description) {
        this.description = description;
        return this;
    }
    ...
    public UserContextServiceAgreementsGetResponseBody withIsMaster(Boolean isMaster) {
        this.isMaster = isMaster;
        return this;
    }
    ...
    public UserContextServiceAgreementsGetResponseBody withValidFromDate(String validFromDate) {
        this.validFromDate = validFromDate;
        return this;
    }
    ...
    public UserContextServiceAgreementsGetResponseBody withValidFromTime(String validFromTime) {
        this.validFromTime = validFromTime;
        return this;
    }
    ...
    public UserContextServiceAgreementsGetResponseBody withValidUntilDate(String validUntilDate) {
        this.validUntilDate = validUntilDate;
        return this;
    }
    ...
    public UserContextServiceAgreementsGetResponseBody withValidUntilTime(String validUntilTime) {
        this.validUntilTime = validUntilTime;
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof UserContextServiceAgreementsGetResponseBody) == false) {
            return false;
        }
        UserContextServiceAgreementsGetResponseBody rhs = ((UserContextServiceAgreementsGetResponseBody) other);
