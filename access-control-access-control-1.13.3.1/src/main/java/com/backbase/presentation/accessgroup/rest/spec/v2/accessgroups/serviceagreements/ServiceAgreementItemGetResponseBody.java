...
public class ServiceAgreementItemGetResponseBody
    extends ServiceAgreementGetResponseBodyParent
{
    ...
    public ServiceAgreementItemGetResponseBody withCreatorLegalEntity(String creatorLegalEntity) {
        this.creatorLegalEntity = creatorLegalEntity;
        return this;
    }
    ...
    public ServiceAgreementItemGetResponseBody withStatus(Status status) {
        this.status = status;
        return this;
    }
    ...
    public ServiceAgreementItemGetResponseBody withApprovalId(String approvalId) {
        this.approvalId = approvalId;
        return this;
    }

    @Override
    public ServiceAgreementItemGetResponseBody withId(String id) {
        super.withId(id);
        return this;
    }

    @Override
    public ServiceAgreementItemGetResponseBody withExternalId(String externalId) {
        super.withExternalId(externalId);
        return this;
    }

    @Override
    public ServiceAgreementItemGetResponseBody withName(String name) {
        super.withName(name);
        return this;
    }

    @Override
    public ServiceAgreementItemGetResponseBody withDescription(String description) {
        super.withDescription(description);
        return this;
    }

    @Override
    public ServiceAgreementItemGetResponseBody withIsMaster(Boolean isMaster) {
        super.withIsMaster(isMaster);
        return this;
    }

    @Override
    public ServiceAgreementItemGetResponseBody withValidFromDate(String validFromDate) {
        super.withValidFromDate(validFromDate);
        return this;
    }

    @Override
    public ServiceAgreementItemGetResponseBody withValidFromTime(String validFromTime) {
        super.withValidFromTime(validFromTime);
        return this;
    }

    @Override
    public ServiceAgreementItemGetResponseBody withValidUntilDate(String validUntilDate) {
        super.withValidUntilDate(validUntilDate);
        return this;
    }

    @Override
    public ServiceAgreementItemGetResponseBody withValidUntilTime(String validUntilTime) {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ServiceAgreementItemGetResponseBody) == false) {
            return false;
        }
        ServiceAgreementItemGetResponseBody rhs = ((ServiceAgreementItemGetResponseBody) other);
