...
public class Cancel implements AdditionalPropertiesAware
{
    ...
    public Cancel withOld(Boolean old) {
        this.old = old;
        return this;
    }
    ...
    public Cancel withNew(Boolean _new) {
        this._new = _new;
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Cancel) == false) {
            return false;
        }
        Cancel rhs = ((Cancel) other);
