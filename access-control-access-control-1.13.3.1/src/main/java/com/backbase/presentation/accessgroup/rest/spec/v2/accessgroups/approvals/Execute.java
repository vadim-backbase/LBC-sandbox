...
public class Execute implements AdditionalPropertiesAware
{
    ...
    public Execute withOld(Boolean old) {
        this.old = old;
        return this;
    }
    ...
    public Execute withNew(Boolean _new) {
        this._new = _new;
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Execute) == false) {
            return false;
        }
        Execute rhs = ((Execute) other);
