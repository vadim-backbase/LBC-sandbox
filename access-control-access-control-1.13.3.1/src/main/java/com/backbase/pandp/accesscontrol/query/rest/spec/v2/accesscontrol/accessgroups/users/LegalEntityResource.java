...
public class LegalEntityResource implements AdditionalPropertiesAware
{
    ...
    public LegalEntityResource withContextServiceAgreementId(String contextServiceAgreementId) {
        this.contextServiceAgreementId = contextServiceAgreementId;
        return this;
    }
    ...
    public LegalEntityResource withUserLegalEntityId(String userLegalEntityId) {
        this.userLegalEntityId = userLegalEntityId;
        return this;
    }
    ...
    public LegalEntityResource withAccessResourceType(AccessResourceType accessResourceType) {
        this.accessResourceType = accessResourceType;
        return this;
    }
    ...
    @Override
    public int hashCode() {
        return new HashCodeBuilder().append(contextServiceAgreementId).append(userLegalEntityId).append(accessResourceType).toHashCode();
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof LegalEntityResource) == false) {
            return false;
        }
        LegalEntityResource rhs = ((LegalEntityResource) other);
        return new EqualsBuilder().append(contextServiceAgreementId, rhs.contextServiceAgreementId).append(userLegalEntityId, rhs.userLegalEntityId).append(accessResourceType, rhs.accessResourceType).isEquals();
    }
