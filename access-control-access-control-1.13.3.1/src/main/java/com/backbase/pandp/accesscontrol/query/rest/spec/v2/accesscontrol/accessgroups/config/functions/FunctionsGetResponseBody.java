...
package com.backbase.pandp.accesscontrol.query.rest.spec.v2.accesscontrol.accessgroups.config.functions;
...
public class FunctionsGetResponseBody implements AdditionalPropertiesAware
{
    ...
    @Valid
    @NotNull
    private List<PersistencePrivilege> privileges = new ArrayList<PersistencePrivilege>();
    /**
    ...
    public FunctionsGetResponseBody withPrivileges(List<PersistencePrivilege> privileges) {
        this.privileges = privileges;
        return this;
    }
