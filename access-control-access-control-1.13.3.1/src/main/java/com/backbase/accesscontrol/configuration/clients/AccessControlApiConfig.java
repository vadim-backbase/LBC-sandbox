...
@ConfigurationProperties("backbase.communication.services.integration.legalentity.external.outbound")
public class AccessControlApiConfig {

    private String serviceId = "legalentity-integration-outbound-service";
     ...
     */
    @Bean
    public LegalEntitiesApi createLegalEntitiesExternalOutboundClientInAccessControl(
