...
@Component
public class UpdateServiceAgreementAdminsBatchDescriptor extends UpdateUsersBase {

    private static final String ENTITY_UPDATED = "Admin";

    @Override
    public AuditEventAction getAuditEventAction() {
        return new AuditEventAction()
            .withObjectType(AuditObjectType.SERVICE_AGREEMENT_ADMINS_UPDATE_BATCH)
