...
public abstract class SegmentationGetResponseBodyToLegalEntityItemMapper
    implements AbstractPayloadConverter<SegmentationGetResponseBody, LegalEntityItem> {

    @Override
    public ConverterKey getConverterKey() {
        return new ConverterKey(SegmentationGetResponseBody.class.getCanonicalName(),
