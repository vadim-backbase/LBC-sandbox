...
public abstract class ServiceAgreementItemToServiceAgreementItemMapper
    ...
    public ConverterKey getConverterKey() {
        return new ConverterKey(ServiceAgreementItem.class.getCanonicalName(),
            com.backbase.accesscontrol.service.rest.spec.model.ServiceAgreementItem.class.getCanonicalName());
    }
}
