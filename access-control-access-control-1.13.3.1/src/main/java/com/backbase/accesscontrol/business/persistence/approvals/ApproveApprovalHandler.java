...
@Component
public class ApproveApprovalHandler extends LeanGenericEventEmitter<SingleParameterHolder<String>, Void, Void> {

    private ApprovalService approvalService;

    public ApproveApprovalHandler(EventBus eventBus, ApprovalService approvalService) {
        super(eventBus);
    ...
    protected Void executeRequest(SingleParameterHolder<String> parameterHolder, Void requestData) {
        approvalService.approveApprovalRequest(parameterHolder.getParameter());
        return null;
    }
