...
/**
 * Test for {@link UserContextController#getUserContextPermissions}
 */
public class GetUserContextPermissionsIT extends TestDbWireMock {
    ...
    public void shouldGetUserContextPermissions() throws Exception {
        ...
        String response = executeClientRequestEntity(new UrlBuilder(GET_USER_CONTEXT_PERMISSIONS_URL)
            .build(), HttpMethod.POST, permissionsRequest, "USER"
        ).getBody();
    ...
    public void shouldThrowBadRequestWhenInvalidDataGroupTypePassedInRequestBody() {
        ...
        BadRequestException exception = assertThrows(BadRequestException.class,
            () -> executeClientRequestEntity(new UrlBuilder(GET_USER_CONTEXT_PERMISSIONS_URL)
                .build(), HttpMethod.POST, permissionsRequest, "USER"
            ));
