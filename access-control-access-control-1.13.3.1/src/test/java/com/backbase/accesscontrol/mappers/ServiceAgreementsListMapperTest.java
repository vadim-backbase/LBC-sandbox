...
public class ServiceAgreementsListMapperTest {

    @InjectMocks
    private com.backbase.accesscontrol.mappers.ServiceAgreementsListMapperImpl serviceAgreementsListMapper;
    ...
    public void shouldConvertListOfSaToServiceAgreementGetResponseBody() {
        ...
        List<ServiceAgreementGetResponseBody> response = serviceAgreementsListMapper
            .mapList(serviceAgreements);

        assertThat(response, containsInAnyOrder(
            getServiceAgreementGetResponseBodyMatcher(firstSa),
            getServiceAgreementGetResponseBodyMatcher(secondSa)
        ));
    }

    private Matcher<ServiceAgreementGetResponseBody> getServiceAgreementGetResponseBodyMatcher(
