...
public class EditServiceAgreementApprovalDescriptorTest {
    ...
    @InjectMocks
    private EditServiceAgreementApprovalDescriptor editServiceAgreementApprovalDescriptor;
    ...
    public void getInitEventDataList() {
        ...
        when(joinPoint.getArgs()).thenReturn(new Object[]{request, serviceAgreementId, approvalId});

        List<AuditMessage> returnedAuditMessages = editServiceAgreementApprovalDescriptor
            .getInitEventDataList(joinPoint);
        AuditMessage auditMessage1 = new AuditMessage()
            .withEventDescription("Request Update | Service Agreement | Initiated | name SA name")
        ...
        AuditMessage auditMessage2 = new AuditMessage()
            ...
            .withEventMetaDatum("Start DateTime", "08-08-2019" + " " + "11:11")
            .withEventMetaDatum("End DateTime", "11-11-2019" + " " + "11:11");
        List<AuditMessage> expectedAuditMessages = asList(auditMessage1, auditMessage2);
    ...
    public void getSuccessEventDataList() {
        ...
        AuditMessage auditMessage1 = new AuditMessage()
            .withEventDescription("Request Update | Service Agreement | Successful | name SA name")
    ...
    public void getFailedEventDataList() {
        ...
        AuditMessage auditMessage1 = new AuditMessage()
            .withEventDescription("Request Update | Service Agreement | Failed | name SA name")
    ...
    public void testGetMessageIds() {
        ...
        List<String> messageIds = editServiceAgreementApprovalDescriptor.getMessageIds(joinPoint);
