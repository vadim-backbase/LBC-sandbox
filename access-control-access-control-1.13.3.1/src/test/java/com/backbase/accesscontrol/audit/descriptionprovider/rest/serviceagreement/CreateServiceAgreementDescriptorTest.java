...
public class CreateServiceAgreementDescriptorTest {
    ...
    @InjectMocks
    private CreateServiceAgreementDescriptor createServiceAgreementDescriptor;
    ...
    public void shouldReturnInitAuditMessageForEveryParticipant() {
        ...
        List<AuditMessage> res = createServiceAgreementDescriptor.getInitEventDataList(joinPoint);

        assertEquals(3, res.size());
        AuditMessage message = res.get(0);
        assertEquals("Create | Service Agreement | Initiated | name SA name", message.getEventDescription());
    ...
    public void shouldReturnAuditMessageForEveryParticipant() {
        ...
        List<AuditMessage> res = createServiceAgreementDescriptor.getSuccessEventDataList(joinPoint,
            new ServiceAgreementPostResponseBody().withId("sa1"));

        assertEquals(3, res.size());
        AuditMessage message = res.get(0);
        assertEquals("Create | Service Agreement | Successful | name SA name", message.getEventDescription());
    ...
    public void shouldReturnFailedAuditMessageForEveryParticipant() {
        ...
        List<AuditMessage> res = createServiceAgreementDescriptor.getFailedEventDataList(joinPoint);

        assertEquals(3, res.size());
        AuditMessage message = res.get(0);
        assertEquals("Create | Service Agreement | Failed | name SA name", message.getEventDescription());
