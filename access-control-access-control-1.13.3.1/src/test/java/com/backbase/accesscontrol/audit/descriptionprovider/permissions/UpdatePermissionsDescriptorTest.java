...
class UpdatePermissionsDescriptorTest {

    @InjectMocks
    private UpdatePermissionsDescriptor updatePermissionsDescriptor;
    ...
    void shouldGetInitEventDataList() {
        ...
        when(joinPoint.getArgs())
            .thenReturn(List.of(new PresentationFunctionDataGroupItems(), new GetUser(), "SA1", "user1").toArray());

        List<AuditMessage> messages = updatePermissionsDescriptor.getInitEventDataList(joinPoint);
    ...
    void shouldGetMultipleAuditMessagesInitEventDataList() {
        ...
        when(joinPoint.getArgs())
            .thenReturn(List.of(presentationFunctionDataGroupItems, new GetUser(), "SA1", "user1").toArray());
    ...
    void shouldGetSuccessEventDataList() {
        ...
        presentationFunctionDataGroupItems.getItems()
        ...
        List<AuditMessage> messages = updatePermissionsDescriptor.getSuccessEventDataList(joinPoint, null);
    ...
    void shouldGetFailedEventDataList() {
        ...
        List<AuditMessage> messages = updatePermissionsDescriptor.getFailedEventDataList(joinPoint);
