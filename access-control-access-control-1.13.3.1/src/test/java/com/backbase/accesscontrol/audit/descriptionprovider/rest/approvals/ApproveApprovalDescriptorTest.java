...
public class ApproveApprovalDescriptorTest {
    ...
    @InjectMocks
    private ApproveApprovalDescriptor approveApprovalDescriptor;
    @Mock
    ...
    public void getInitEventDataListTest() {
        ...
        AuditMessage expectedEventList = new AuditMessage()
            ...
            .withEventDescription(
                "Approve pending operation | Initiated | for user " + USER_ID + " in service agreement "
                    + SERVICE_AGREEMENT_ID)
            .withEventMetaDatum("Approval Request ID", approvalId)
            .withEventMetaDatum("Outcome", "APPROVED");

        List<AuditMessage> actualEventList = approveApprovalDescriptor.getInitEventDataList(joinPoint);
    ...
    public void getInitEventDataListWhenUserIsAnonymousTest() {
        ...
        AuditMessage expectedEventList = new AuditMessage()
            .withStatus(Status.INITIATED)
            .withEventDescription("Approve pending operation | Initiated | for user anonymous in service agreement "
                + SERVICE_AGREEMENT_ID)
            .withEventMetaDatum("Approval Request ID", approvalId)
            .withEventMetaDatum("Outcome", "APPROVED");
    ...
    public void getSuccessEventDataListTest() {
        ...
        AuditMessage expectedEventList = new AuditMessage()
            ...
            .withEventDescription(
                "Approve pending operation | Successful | for user " + USER_ID + " in service agreement "
                    + SERVICE_AGREEMENT_ID)
            .withEventMetaDatum("Approval Request ID", approvalId)
            .withEventMetaDatum("Outcome", "APPROVED");
        ...
        List<AuditMessage> actualEventList = approveApprovalDescriptor
    ...
    public void getFailedEventDataListTest() {
        ...
        AuditMessage expectedEventList = new AuditMessage()
            ...
            .withEventDescription("Approve pending operation | Failed | for user " + USER_ID + " in service agreement "
                + SERVICE_AGREEMENT_ID)
            .withEventMetaDatum("Approval Request ID", approvalId)
            .withEventMetaDatum("Outcome", "APPROVED");
        ...
        List<AuditMessage> actualEventList = approveApprovalDescriptor.getFailedEventDataList(joinPoint);
    ...
    public void shouldReturnApprovalIdAsMessageId() {
        ...
        List<String> messageIds = approveApprovalDescriptor.getMessageIds(joinPoint);
