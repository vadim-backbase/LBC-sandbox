...
public class CreateDataGroupDescriptorTest {

    @InjectMocks
    private CreateDataGroupDescriptor createDataGroupDescriptor;
    @Mock
    ...
    public void getSuccessEventDataList() {
        ...
        AuditMessage expectedEventList = new AuditMessage()
            ...
            .withEventMetaDatum("Data Group ID", "idDG")
    ...
    public void getInitEventDataListWithExternalSaId() {
        ...
        AuditMessage expectedEventList = new AuditMessage()
            ...
            .withEventMetaDatum("Service Agreement ID", "ex")
            .withEventMetaDatum("Data Group Type", "type")
            .withEventDescription("Create | Data Group | Initiated | name Name, service agreement ID ex, "
                + "type type");
        List<AuditMessage> actualEventList = createDataGroupDescriptor
    ...
    public void getFailedEventDataListWithExternalSaId() {
        ...
        AuditMessage expectedEventList = new AuditMessage()
            ...
            .withEventMetaDatum("Service Agreement ID", "ex")
            .withEventMetaDatum("Data Group Type", "type")
            .withEventDescription("Create | Data Group | Failed | name Name, service agreement ID ex, "
                + "type type");
        List<AuditMessage> actualEventList = createDataGroupDescriptor
