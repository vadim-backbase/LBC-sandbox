...
/**
 * Tests for {@link UpdateDataGroupApprovalDescriptorTest}
 */
@RunWith(MockitoJUnitRunner.class)
public class UpdateDataGroupApprovalDescriptorTest {

    @InjectMocks
    private UpdateDataGroupApprovalDescriptor updateDataGroupDescriptor;
    @Mock
    ...
    public void getMessageIdsTest() {
        ...
        DataGroupByIdPutRequestBody dataGroupBaseUpdated = new DataGroupByIdPutRequestBody()
        ...
        when(joinPoint.getArgs())
            .thenReturn(asList(dataGroupBaseUpdated, approvalId).toArray());

        List<String> messageIds = updateDataGroupDescriptor
    ...
    public void getSuccessEventDataList() {
        ...
        AuditMessage expectedEventList = new AuditMessage()
            ...
            .withEventDescription("Request Update | Data Group | Successful | name Name, service agreement ID ex, type type");
    ...
    public void getInitEventDataListWithExternalSaId() {
        ...
        AuditMessage expectedEventList = new AuditMessage()
            ...
            .withEventMetaDatum("Service Agreement ID", "ex")
            .withEventMetaDatum("Data Group Type", "type")
            .withEventDescription("Request Update | Data Group | Initiated | name Name, service agreement ID ex, "
                + "type type");
        List<AuditMessage> actualEventList = updateDataGroupDescriptor
    ...
    public void getFailedEventDataListWithExternalSaId() {
        ...
        AuditMessage expectedEventList = new AuditMessage()
            ...
            .withEventMetaDatum("Service Agreement ID", "ex")
            .withEventMetaDatum("Data Group Type", "type")
            .withEventDescription("Request Update | Data Group | Failed | name Name, service agreement ID ex, "
                + "type type");
        List<AuditMessage> actualEventList = updateDataGroupDescriptor
