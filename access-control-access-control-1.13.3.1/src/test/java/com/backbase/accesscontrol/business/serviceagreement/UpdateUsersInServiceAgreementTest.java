...
public class UpdateUsersInServiceAgreementTest {
    ...
    @InjectMocks
    private UpdateUsersInServiceAgreement updateUsersInServiceAgreement;

    @Test
    public void testIngestUsersUpdateAdd() {
        ...
        List<com.backbase.dbs.user.api.client.v2.model.GetUser> usersResponse = new ArrayList<>();
        ...
        when(modifyUsersAndAdminsInServiceAgreement.processBatch(eq(UserType.REGULAR_USER),
        ...
        List<BatchResponseItemExtended> response = updateUsersInServiceAgreement.updateUsersInServiceAgreement(request)
            .getData();

        verify(modifyUsersAndAdminsInServiceAgreement)
            .processBatch(eq(UserType.REGULAR_USER), eq(new PresentationServiceAgreementUsersUpdate()
    ...
    @Test
    public void testIngestusersUpdateRemove() {
        String invalidExternalUserId = "U-02";
        String validExternalUserId = "U-01";
        String validInternalUserId = "0001";
        String legalEntityId = "LE-01";
    ...
    @Test
    public void shouldCallAddUsersPandpWhenActionIsAdd() {
        PresentationServiceAgreementUsersUpdate data = new PresentationServiceAgreementUsersUpdate()
            .withAction(PresentationAction.ADD);
        InternalRequest<PresentationServiceAgreementUsersUpdate> request = RequestUtils.getInternalRequest(
            data);

        updateUsersInServiceAgreement.updateUsersInServiceAgreement(request);
    ...
    @Test
    public void shouldCallAddUsersPandpWhenActionIsRemove() {
        PresentationServiceAgreementUsersUpdate data = new PresentationServiceAgreementUsersUpdate()
            .withAction(PresentationAction.REMOVE);
        InternalRequest<PresentationServiceAgreementUsersUpdate> request = RequestUtils.getInternalRequest(
            data);
    ...
    @Test
    public void testIngestDuplicateUsersUpdateAdd() {
        String validExternalUserId = "U-01";
        String validInternalUserId = "0001";
        String legalEntityId = "LE-01";
        String externalServiceAgreementId = "SA-01";
