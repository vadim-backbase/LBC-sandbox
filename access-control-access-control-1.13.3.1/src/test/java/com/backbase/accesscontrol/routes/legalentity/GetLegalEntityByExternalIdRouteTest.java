...
public class GetLegalEntityByExternalIdRouteTest extends BaseTestRoutesBuilder<GetLegalEntityByExternalIdRoute> {
    ...
    public void initialize() throws Exception {
        setupAdvice(EndpointConstants.DIRECT_DEFAULT_GET_LEGAL_ENTITY_BY_EXTERNAL_ID);
        mockEndpoint = getMockEndpoint("mock:" + EndpointConstants.DIRECT_DEFAULT_GET_LEGAL_ENTITY_BY_EXTERNAL_ID);
    }
    ...
    public void mockedEndpointShouldReceiveMessage() throws Exception {
        ...
        InternalRequest<LegalEntityByExternalIdGetResponseBody> inRequest = new InternalRequest<>();
