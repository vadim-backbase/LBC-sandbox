...
public class GetLegalEntityForCurrentUserRouteTest extends BaseTestRoutesBuilder<GetLegalEntityForCurrentUserRoute> {
    ...
    public void initialize() throws Exception {
        setupAdvice(EndpointConstants.DIRECT_DEFAULT_GET_LEGAL_ENTITY_FOR_CURRENT_USER);
        mockEndpoint = getMockEndpoint("mock:" + EndpointConstants.DIRECT_DEFAULT_GET_LEGAL_ENTITY_FOR_CURRENT_USER);
    }
    ...
    public void mockedEndpointShouldReceiveMessage() throws Exception {
        ...
        InternalRequest<LegalEntityForUserGetResponseBody> inRequest = new InternalRequest<>();
