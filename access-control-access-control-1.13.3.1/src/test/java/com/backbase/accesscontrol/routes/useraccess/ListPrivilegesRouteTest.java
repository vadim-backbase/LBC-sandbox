 ...
 */
public class ListPrivilegesRouteTest extends BaseTestRoutesBuilder<ListPrivilegesRoute> {

    private MockEndpoint mockFunctions;

    @Before
    public void setup() throws Exception {
        setupAdvice(EndpointConstants.DIRECT_DEFAULT_LIST_PRIVILEGES);
        mockFunctions = getMockEndpoint("mock:" + EndpointConstants.DIRECT_DEFAULT_LIST_PRIVILEGES);
    }
    ...
    public void shouldPassWhenMessageCorrectlySentAndConsumedByMockEndpoint() throws Exception {
        ...
        context.start();
        template.sendBody(EndpointConstants.DIRECT_BUSINESS_LIST_PRIVILEGES, "payload");
