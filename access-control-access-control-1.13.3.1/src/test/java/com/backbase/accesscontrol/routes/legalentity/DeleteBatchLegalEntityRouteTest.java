...
public class DeleteBatchLegalEntityRouteTest extends BaseTestRoutesBuilder<DeleteBatchLegalEntityRoute> {
    ...
    public void initialize() throws Exception {
        setupAdvice(EndpointConstants.DIRECT_DEFAULT_DELETE_BATCH_LEGAL_ENTITY);
        mockEndpoint = getMockEndpoint("mock:" + EndpointConstants.DIRECT_DEFAULT_DELETE_BATCH_LEGAL_ENTITY);
    }
