...
public class GetMasterServiceAgreementByExternalLegalEntityIdRouteTest extends
    BaseTestRoutesBuilder<GetMasterServiceAgreementByExternalLegalEntityIdRoute> {
    ...
    public void initialize() throws Exception {
        setupAdvice(EndpointConstants.DIRECT_DEFAULT_GET_MASTER_SERVICE_AGREEMENT_BY_EXTERNAL_LEGAL_ENTITY_ID);
        mockEndpoint = getMockEndpoint(
            "mock:" + EndpointConstants.DIRECT_DEFAULT_GET_MASTER_SERVICE_AGREEMENT_BY_EXTERNAL_LEGAL_ENTITY_ID);
    }
